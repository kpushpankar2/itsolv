...
var crossStringClick = function (elem) {
   var target = elem;
   var parentWithActiveClass = findClosestParentWithClass(larget,'active');
...
var closestParent = findClosestParentWithClass(myElement, "someClassName");
...
$(document).ready(function () {
   ...
   document.querySelectorAll(".custmonDropDwon").click(function (e) {
      if ((e.target).classList.contain("crossString") || (e.target).classList.contain("bowiro")) {
         return false;
      }
      ...
      if (e.target.classList.contain("language") || e.target.parentElement.classList.contains("language")) {
         languageFunc();
      ...
      var drop = dropDown.nextElementSibling || dropDown.children[0];

      if (drop) {
         drop.classList.add("active");
      } else {
         dropDown.children[0].classList.add("active");
      }
   ...
   document.querySelectorAll(".basic_banner_read_btn").forEach(function(readBtn){
      readBtn.addEventListener("click",function(){
         var basicbtntxt = document.querySelector(".basic_banner_text");
         if (basic_banner_read_btn == false) {
            readBtn.textCon("Read Less");
   ...
   var btn = document.querySelectorAll(".basic_banner_read_btn")
   ...
   document.querySelectorAll(".hideCustomDrp").forEach(function(btn){
      btn.addEventListener("click",function(){
         document.querySelectorAll(".customDrp").forEach(function(custmonDrp){
            custmonDrp.classList.remove("active");
         })
      });
   })
   ...
   document.querySelectorAll(".closeIcon").forEach(function(btn){
      btn.addEventListener('click',function(){
   ...
   document.querySelectorAll('.currenciesTable, .exchangeTable').addEventListener("scroll",function(e){
      let isScroll = e.currentTarget.scrollLeft;
      if (isScroll) {
         document.querySelectorAll(".ListingTable th:nth-child(2), td:nth-child(2)").forEach(function(element){
            element.classList.add("before");
         })
      } else {
         document.querySelectorAll(".ListingTable th:nth-child(2), td:nth-child(2)").forEach(function(element){
    ...
    // .historical-data
   document.querySelectorAll('.historical-data').addEventListener("scroll",function(e){
      let isScroll = e.currentTarget.scrollLeft;
      if (isScroll) {
         document.querySelectorAll(".ListingTable th:nth-child(2), td:nth-child(2)").forEach(function(element){
            element.classList.add("before");
         ...
         document.querySelectorAll(".ListingTable th:nth-child(1), td:nth-child(1)").forEach(function(element){
            element.classList.remove("before");
         })
      }
   })
   ...
   document.querySelectorAll('.financialTable').addEventListener("scroll",function(e){
      let isScroll = e.currentTarget.scrollLeft;
      if (isScroll) {
         document.querySelectorAll(".ListingTable th:nth-child(1), td:nth-child(1)").forEach(function(element){
            element.classList.add("before");
   ...
   document.querySelectorAll(".header-for-mobile .searchPopup").addEventListener("click",function(){
      document.body.style.overflow='hidden';
      document.querySelector(".searchDiv-for-mb").classList.add("active");
   });

   document.querySelectorAll(".searchpopupHider").addEventListener("click",function(){
      document.body.style.overflow='auto';
   ...
   // == end sticky thead == //
  var isHighLight = document.getElementById("HighlightsBox");
  isHighLight.addEventListener("click",function(){
   var bannerCards = document.querySelectorAll(".Banner_cards");
...
function toggleCurrencyMoreData(elem) {
   ...
   if (currentstate == alternate) {
      var bottomListing = document.querySelectorAll(".currencyDetail .bottomListing");
      bottomListing.forEach(function(item){
